...
('body[0].names[0]', None, None, 'name', {'_ver': 15}, ('exec',
r'''lazy import oldname as thing'''), (None,
r'''new'''),
r'''lazy import new as thing''', r'''
...
('body[0].names[0]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy import a as b'''), (None,
r'''new'''),
r'''lazy import a as new''', r'''
Module - ROOT 0,0..0,20
  .body[1]
   0] Import - 0,0..0,20
     .names[1]
...
('body[0].names[0]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy import a as b, c'''), (None,
r'''new'''),
r'''lazy import a as new, c''', r'''
Module - ROOT 0,0..0,23
  .body[1]
   0] Import - 0,0..0,23
     .names[2]
...
('body[0].names[1]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy import c, a as b'''), (None,
r'''new'''),
r'''lazy import c, a as new''', r'''
Module - ROOT 0,0..0,23
  .body[1]
   0] Import - 0,0..0,23
     .names[2]
...
('body[0].names[0]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy from z import (a as b)'''), (None,
r'''new'''),
r'''lazy from z import (a as new)''', r'''
Module - ROOT 0,0..0,29
  .body[1]
...
('body[0].names[0]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy from z import (a as b, c)'''), (None,
r'''new'''),
r'''lazy from z import (a as new, c)''', r'''
Module - ROOT 0,0..0,32
  .body[1]
   0] ImportFrom - 0,0..0,32
     .module 'z'
     .names[2]
      0] alias - 0,20..0,28
        .name 'a'
...
('body[0].names[1]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy from z import (c, b as a)'''), (None,
r'''new'''),
r'''lazy from z import (c, b as new)''', r'''
Module - ROOT 0,0..0,32
  .body[1]
   0] ImportFrom - 0,0..0,32
     .module 'z'
...
('body[0].names[1]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy from z import (c, a as b)'''), (None,
r'''**DEL**'''),
r'''lazy from z import (c, a)''', r'''
Module - ROOT 0,0..0,25
  .body[1]
   0] ImportFrom - 0,0..0,25
     .module 'z'
...
('body[0].names[1]', None, None, 'asname', {'_ver': 15}, ('exec',
r'''lazy from z import (c, a)'''), (None,
r'''new'''),
r'''lazy from z import (c, a as new)''', r'''
Module - ROOT 0,0..0,32
  .body[1]
   0] ImportFrom - 0,0..0,32
     .module 'z'
...
('body[0]', 0, None, 'names', {'_ver': 15}, ('exec',
r'''lazy import a, c.d as e'''), (None,
r'''**DEL**'''),
r'''lazy import c.d as e''', r'''
Module - ROOT 0,0..0,20
  .body[1]
   0] Import - 0,0..0,20
     .names[1]
...
('body[0]', 0, None, 'names', {'_ver': 15}, ('exec',
r'''lazy import a, c.d as e'''), ('alias',
r'''f as g'''),
r'''lazy import f as g, c.d as e''', r'''
Module - ROOT 0,0..0,28
  .body[1]
   0] Import - 0,0..0,28
     .names[2]
...
('body[0]', 1, None, 'names', {'_ver': 15}, ('exec',
r'''lazy import a, c.d as e'''), ('alias',
r'''f as g'''),
r'''lazy import a, f as g''', r'''
Module - ROOT 0,0..0,21
  .body[1]
   0] Import - 0,0..0,21
     .names[2]
...
('body[0]', -2, None, 'names', {'_ver': 15}, ('exec',
r'''lazy import a, c.d as e'''), ('alias',
r'''f as g'''),
r'''lazy import f as g, c.d as e''', r'''
Module - ROOT 0,0..0,28
...
('body[0]', -4, None, 'names', {'_ver': 15}, ('exec',
r'''lazy import a, c.d as e'''), ('alias',
r'''f as g'''),
r'''**IndexError('index out of range')**'''),
...
r'''lazy import a, c.d as e'''), ('alias',
r'''x.y as z'''),
r'''lazy import x.y as z, c.d as e''', r'''
Module - ROOT 0,0..0,30
  .body[1]
   0] Import - 0,0..0,30
     .names[2]
...
('', 0, None, 'names', {'_ver': 15, 'raw': False}, (None,
r'''lazy import _'''), (None,
r'''(a)'''),
r'''**SyntaxError('invalid syntax')**'''),

('', 0, None, 'names', {'_ver': 15, 'coerce': False}, (None,
r'''lazy import _'''), (None,
r'''(a)'''),
r'''**SyntaxError('invalid syntax')**'''),

('', 0, None, 'names', {'_ver': 15}, ('Import',
r'''lazy import _'''), ('alias',
r'''*'''),
r'''**SyntaxError('invalid syntax')**'''),
],
...
('body[0]', None, None, 'module', {'_ver': 15}, ('exec',
r'''lazy from a import *'''), (None,
r'''new'''),
r'''lazy from new import *''', r'''
Module - ROOT 0,0..0,22
  .body[1]
   0] ImportFrom - 0,0..0,22
     .module 'new'
...
('body[0]', None, None, 'module', {'_ver': 15}, ('exec', r'''
from . \
 .\
a import *
'''), (None,
...
('body[0]', 0, None, 'names', {'_ver': 15}, ('exec',
r'''lazy from z import (a, c as d)'''), ('alias',
r'''**DEL**'''),
r'''lazy from z import (c as d)''', r'''
Module - ROOT 0,0..0,27
  .body[1]
   0] ImportFrom - 0,0..0,27
     .module 'z'
...
r'''lazy from z import (a, c as d)'''), ('alias',
r'''f as g'''),
r'''lazy from z import (f as g, c as d)''', r'''
Module - ROOT 0,0..0,35
  .body[1]
   0] ImportFrom - 0,0..0,35
     .module 'z'
     .names[2]
      0] alias - 0,20..0,26
        .name 'f'
...
r'''lazy from z import (a, c as d)'''), ('alias',
r'''f as g'''),
r'''lazy from z import (a, f as g)''', r'''
Module - ROOT 0,0..0,30
  .body[1]
...
('', 0, None, 'names', {'_ver': 15}, ('ImportFrom',
r'''lazy from . import _'''), ('alias',
r'''*'''),
r'''lazy from . import *''', r'''
...
r'''i = v'''), ('Return',
r'''return fail'''),
r'''**NodeError('expecting expression (standard), got Return, could not coerce')**'''),
...
r'''i = v'''), ('arguments',
r'''*x: int'''),
r'''**NodeError('expecting expression (standard), got arguments, could not coerce, vararg has annotation')**'''),

('', None, None, 'value', {'_src': False, 'raw': False}, (None,
r'''i = v'''), ('arguments',
r'''*, x'''),
r'''**NodeError("expecting expression (standard), got arguments, could not coerce, has empty vararg '*'")**'''),

('', None, None, 'value', {'_src': False, 'raw': False}, (None,
r'''i = v'''), ('arguments',
r'''x: int'''),
r'''**NodeError('expecting expression (standard), got arguments, could not coerce, arg has annotation')**'''),

('', None, None, 'value', {'_src': False}, (None,
r'''i = v'''), ('arguments',
r'''*x, y: int'''),
r'''**NodeError('expecting expression (standard), got arguments, could not coerce, kwonlyarg has annotation')**'''),
...
r'''def f(): pass'''), ('Tuple',
r'''*a, *b'''),
r'''**NodeError('expecting arguments, got Tuple, could not coerce')**'''),

('', None, None, 'args', {'_src': False}, ('Lambda',
r'''lambda: None'''), ('Tuple',
r'''a, b'''),
r'''lambda a, b: None''', r'''
...
r'''a as b'''), ('Return',
r'''return fail'''),
r'''**NodeError('expecting pattern, got Return, could not coerce')**'''),
...
r'''a as b'''), ('Constant',
r'''...'''),
r'''**NodeError('expecting pattern, got Constant, could not coerce')**'''),
...
r'''"st" "r" as b''',
r''''str' as b''', r'''
MatchAs - ROOT 0,0..0,13
  .pattern MatchValue - 0,0..0,8
    .value Constant 'str' - 0,0..0,8
  .name 'b'
'''),
...
r'''b"byt" b"es" as b''',
r'''b'bytes' as b''', r'''
MatchAs - ROOT 0,0..0,17
  .pattern MatchValue - 0,0..0,12
    .value Constant b'bytes' - 0,0..0,12
  .name 'b'
'''),
...
r'''True'''),
r'''True as b''', r'''
MatchAs - ROOT 0,0..0,9
  .pattern MatchSingleton True - 0,0..0,4
  .name 'b'
'''),
...
MatchAs - ROOT 0,0..0,10
  .pattern MatchSingleton False - 0,0..0,5
  .name 'b'
'''),
...
r'''None as b''', r'''
MatchAs - ROOT 0,0..0,9
  .pattern MatchSingleton None - 0,0..0,4
  .name 'b'
'''),
...
r'''a as b'''), ('Attribute',
r'''f().b.c'''),
r'''**NodeError('expecting pattern, got Attribute, could not coerce')**'''),

('', 0, None, 'patterns', {'_src': False}, ('MatchSequence',
r'''[a]'''), ('Starred',
r'''*a'''),
r'''[*a]''', r'''
...
('', 0, None, 'patterns', {'_src': False, 'raw': False}, ('MatchSequence',
r'''[a]'''), ('Starred',
r'''*(a)'''),
r'''[*a]''', r'''
MatchSequence - ROOT 0,0..0,4
...
r'''[a]'''), ('Starred',
r'''*a.b'''),
r'''**NodeError('expecting pattern, got Starred, could not coerce')**'''),
...
r'''a as b'''), ('Call',
r'''f().b()'''),
r'''**NodeError('expecting pattern, got Call, could not coerce')**'''),
...
r'''a as b'''), ('_comprehension_ifs',
r'''if f().b'''),
r'''**NodeError('expecting pattern, got _comprehension_ifs, could not coerce')**'''),
],
