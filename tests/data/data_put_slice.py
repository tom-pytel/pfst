...
('body[0].value', 0, 2, None, {'one': None}, ('exec',
r'''1, 2'''), (None, r'''
(
...
('body[0].body[0].value', 0, 2, None, {'one': None, 'norm': True}, ('exec', r'''
if 1:
  {1, 2}
'''), (None, r'''
(
...
('body[0].value', 1, 2, None, {'one': None}, ('exec',
r'''(1, 2)'''), (None,
r'''()'''),
r'''(1,)''', r'''
Module - ROOT 0,0..0,4
...
('body[0].value', 1, 2, None, {'one': None, 'norm': True}, ('exec',
r'''(1, 2)'''), (None,
r'''{*()}'''),
r'''(1, *())''', r'''
Module - ROOT 0,0..0,8
...
('body[0].value', 0, 2, None, {'one': None, 'norm': True}, ('exec',
r'''1, 2'''), (None,
r'''{*()}'''),
r'''*(),''', r'''
Module - ROOT 0,0..0,4
...
('body[0].value', 0, 2, None, {'one': None}, ('exec', r'''
[            # hello
    1, 2, 3
]
'''), (None,
...
('body[0].value', 0, 1, None, {'one': None}, ('exec', r'''
[            # hello
    a, b, c
]
'''), (None, r'''
...
('body[0].value', 1, 2, None, {'one': None}, ('exec', r'''
[            # hello
    a, b, c
]
'''), (None, r'''
...
('body[0].value', 2, 3, None, {'one': None}, ('exec', r'''
[            # hello
    a, b, c
]
'''), (None, r'''
...
('body[0].value', 2, 3, None, {'one': None}, ('exec',
'[            # hello\n    a, b, c   \n]'), (None, r'''
[3
]
'''), r'''
...
('body[0].value', 0, 0, None, {'one': None}, ('exec', r'''
[            # hello
    a, b
]
'''), (None, r'''
...
('body[0].value', 1, 1, None, {'one': None}, ('exec', r'''
[            # hello
    a, b
]
'''), (None, r'''
...
('body[0].value', 2, 2, None, {'one': None}, ('exec', r'''
[            # hello
    a, b
]
'''), (None, r'''
...
('body[0].targets[0]', 2, 2, None, {'one': None}, ('exec',
r'''[a, b] = c'''), (None,
r'''(d,)'''),
r'''[a, b, d] = c''', r'''
...
('body[0].value', 0, 1, None, {'one': None}, ('exec',
r'''stat_list,'''), (None, r'''
[ {-1: "stdname",
...
('body[0].iter', 1, 2, None, {'one': None}, ('exec', r'''
for a in a, b:
    pass
'''), (None, r'''
(
...
('body[0].value', 0, 0, None, {'one': None}, ('exec',
...
('body[0].body[0].value.elts[1]', 1, 2, None, {'one': None}, ('exec', r'''
if 1:
  [1,  [
        2, 3, 4]]
'''), (None, r'''
...
('body[0].body[0].value.elts[1]', 2, 3, None, {'one': None}, ('exec', r'''
if 1:
  [1,  [
        2,
        3, 4]]
...
('body[0].body[0].value.elts[1]', 0, 2, None, {'one': None}, ('exec', r'''
if 1:
  [1,  [
        2, 3, 4]]
'''), (None, r'''
...
('body[0].body[0].value.elts[1]', 0, 3, None, {'one': None}, ('exec', r'''
if 1:
  [1,  [
        2,
        3, 4]]
...
('body[0].body[0].value.elts[1]', 1, 3, None, {'one': None}, ('exec', r'''
if 1:
  [1,  [
    2,
    3, 4],
...
('body[0].value.slice', 1, 2, None, {'one': None}, ('exec',
...
('body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 0}, ('exec', r'''
[
# c0
...
('body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 1}, ('exec', r'''
[
# c0
...
('body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 2}, ('exec', r'''
[
# c0
...
('body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 3}, ('exec', r'''
[
# c0
...
('body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 4}, ('exec', r'''
[
# c0
...
('body[0].body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 0}, ('exec', r'''
if 1: [
    # c0
...
('body[0].body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 1}, ('exec', r'''
if 1: [
    # c0
...
('body[0].body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 2}, ('exec', r'''
if 1: [
    # c0
...
('body[0].body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 3}, ('exec', r'''
if 1: [
    # c0
...
('body[0].body[0].value', 0, 0, None, {'one': None, 'trivia': (False, False), 'ins_ln': 4}, ('exec', r'''
if 1: [
    # c0
...
('body[0].body[0].value', 1, 1, None, {'one': None, 'trivia': (False, False), 'ins_ln': 0}, ('exec', r'''
if 1: [x,
    # c0
...
('body[0].body[0].value', 1, 1, None, {'one': None, 'trivia': (False, False), 'ins_ln': 1}, ('exec', r'''
if 1: [x,
    # c0
...
('body[0].body[0].value', 1, 1, None, {'one': None, 'trivia': (False, False), 'ins_ln': 2}, ('exec', r'''
if 1: [x,
    # c0
...
('body[0].body[0].value', 1, 1, None, {'one': None, 'trivia': (False, False), 'ins_ln': 3}, ('exec', r'''
if 1: [x,
    # c0
...
('body[0].body[0].value', 1, 1, None, {'one': None, 'trivia': (False, False), 'ins_ln': 4}, ('exec', r'''
if 1: [x,
    # c0
...
('body[0].body[0]', 1, 1, None, {'one': None}, ('exec', r'''
if 1:
  del a
'''), (None, r'''
(
...
('body[0]', 1, 2, None, {'one': None, 'norm': True}, ('exec',
r'''global a, b, c  # comment'''), (None,
r'''{*()}'''),
...
r'''f=g, **h'''),
r'''class cls(a, b=c, *d, f=g, **h): pass''', r'''
ClassDef - ROOT 0,0..0,37
  .name 'cls'
  .bases[2]
   0] Name 'a' Load - 0,10..0,11
   1] Starred - 0,18..0,20
  ...
  .keywords[3]
   ...
   1] keyword - 0,22..0,25
     .arg 'f'
     .value Name 'g' Load - 0,24..0,25
   2] keyword - 0,27..0,30
     .value Name 'h' Load - 0,29..0,30
  .body[1]
   0] Pass - 0,33..0,37
'''),
...
('', 0, 1, '_bases', {}, ('ClassDef',
r'''class cls(a0, b0): pass'''), ('_arglikes',
r'''c0'''),
...
('', 0, 1, '_bases', {}, ('ClassDef',
r'''class cls(a0, *b1): pass'''), ('_arglikes',
r'''c0'''),
...
('', 0, 1, '_bases', {}, ('ClassDef',
r'''class cls(a0, b=2): pass'''), ('_arglikes',
r'''c0'''),
...
('', 0, 1, '_bases', {}, ('ClassDef',
r'''class cls(a0, **b3): pass'''), ('_arglikes',
r'''c0'''),
...
('', 1, 'end', '_bases', {}, ('ClassDef',
r'''class cls(*a1, **b3): pass'''), ('_arglikes',
r'''c0'''),
...
('', 1, 'end', '_bases', {}, ('ClassDef',
r'''class cls(a=2, **b3): pass'''), ('_arglikes',
r'''c0'''),
r'''**NodeError('positional arglike cannot follow keyword arglike')**'''),

('', 1, 'end', '_bases', {}, ('ClassDef',
r'''class cls(**a3, **b3): pass'''), ('_arglikes',
r'''c0'''),
...
('', 0, 'end', '_bases', {}, ('ClassDef',
r'''class cls: pass'''), ('_arglikes',
r'''a, *not b, c, e=f, *g, **h, i=j'''),
r'''class cls(a, *not b, c, e=f, *g, **h, i=j): pass''',
r'''class cls(a, *(not b), c, e=f, *g, **h, i=j): pass''', r'''
ClassDef - ROOT 0,0..0,48
  .name 'cls'
  .bases[4]
   0] Name 'a' Load - 0,10..0,11
   1] Starred - 0,13..0,19
   ...
   3] Starred - 0,29..0,31
     .value Name 'g' Load - 0,30..0,31
     .ctx Load
  .keywords[3]
   0] keyword - 0,24..0,27
     .arg 'e'
     .value Name 'f' Load - 0,26..0,27
   1] keyword - 0,33..0,36
     .value Name 'h' Load - 0,35..0,36
   2] keyword - 0,38..0,41
     .arg 'i'
     .value Name 'j' Load - 0,40..0,41
  .body[1]
   0] Pass - 0,44..0,48
'''),
...
'ClassDef__bases_coerce': [  # ................................................................................

('', 1, 3, '_bases', {'one': True}, (None,
...
ClassDef - ROOT 0,0..0,22
  ...
  .bases[2]
   0] Name 'a' Load - 0,10..0,11
   1] Starred - 0,13..0,15
     .value Name 's' Load - 0,14..0,15
     .ctx Load
  .body[1]
   0] Pass - 0,18..0,22
'''),

('', 1, 3, '_bases', {'coerce': False}, (None,
r'''class cls(a, b, c): pass'''), ('expr',
r'''*s'''),
...
Call - ROOT 0,0..0,26
  ...
  .keywords[3]
   ...
   1] keyword - 0,17..0,20
     .arg 'f'
     .value Name 'g' Load - 0,19..0,20
   2] keyword - 0,22..0,25
     .value Name 'h' Load - 0,24..0,25
'''),
...
('', 1, 'end', '_args', {}, ('Call',
r'''call(a=2, **b3)'''), ('_arglikes',
r'''c0'''),
r'''**NodeError('positional arglike cannot follow keyword arglike')**'''),

('', 1, 'end', '_args', {}, ('Call',
r'''call(**a3, **b3)'''), ('_arglikes',
r'''c0'''),
r'''**NodeError('positional arglike cannot follow keyword arglike unpacking')**'''),
...
r'''call(a, *(not b), c, e=f, *g, **h, i=j)''', r'''
Call - ROOT 0,0..0,37
  .func Name 'call' Load - 0,0..0,4
  .args[4]
   0] Name 'a' Load - 0,5..0,6
   ...
   2] Name 'c' Load - 0,16..0,17
   3] Starred - 0,24..0,26
     .value Name 'g' Load - 0,25..0,26
     .ctx Load
  .keywords[3]
   0] keyword - 0,19..0,22
     .arg 'e'
     .value Name 'f' Load - 0,21..0,22
   1] keyword - 0,28..0,31
     .value Name 'h' Load - 0,30..0,31
   2] keyword - 0,33..0,36
     .arg 'i'
...
Call - ROOT 0,0..0,11
  ...
  .args[2]
   0] Name 'a' Load - 0,5..0,6
   1] Starred - 0,8..0,10
     .value Name 's' Load - 0,9..0,10
     .ctx Load
'''),

('', 1, 3, '_args', {'coerce': False}, (None,
r'''call(a, b, c)'''), ('expr',
r'''*s'''),
r'''call(a, *s)''',
r'''**NodeError('expecting _arglikes, got Starred, coerce disabled')**''', r'''
...
arguments - ROOT 0,0..2,7
  .kwonlyargs[2]
   ...
   1] arg - 2,4..2,5
     .arg 'b'
  .kw_defaults[2]
   0] Constant 1j - 1,6..1,8
   1] Constant 2 - 2,6..2,7
'''),
...
arguments - ROOT 0,0..0,12
  .kwonlyargs[2]
   ...
   1] arg - 0,9..0,10
     .arg 'b'
  .kw_defaults[2]
   0] Constant 1j - 0,5..0,7
   1] Constant 2 - 0,11..0,12
'''),

('', 0, 2, '_all', {}, ('arguments', r'''
    a=1,
    *,
    b=2
'''), ('arguments', r'''
...
arguments - ROOT 0,0..3,5
  ...
  .kwonlyargs[2]
   ...
   1] arg - 3,2..3,3
     .arg 'b'
  .kw_defaults[2]
   0] Constant 1j - 2,4..2,6
   1] Constant 2 - 3,4..3,5
  .defaults[1]
...
arguments - ROOT 0,0..0,17
  ...
  .kw_defaults[2]
   0] Constant 1j - 0,10..0,12
   1] Constant 2 - 0,16..0,17
  .defaults[1]
   0] Constant 1 - 0,2..0,3
'''),

('', 1, 3, '_all', {}, ('arguments', r'''
  a=1,
  *c,
  b=2
'''), ('arguments', r'''
...
arguments - ROOT 0,0..5,6
  ...
  .kwonlyargs[2]
   ...
   1] arg - 5,2..5,3
     .arg 'e'
  .kw_defaults[2]
   0] Constant 2j - 4,4..4,6
   1] Constant 4 - 5,4..5,5
  .defaults[2]
   0] Constant 1 - 0,4..0,5
   1] Constant 1j - 1,4..1,6
'''),

('', 1, 3, '_all', {}, ('arguments',
r'''a=1, b=2, /, *, d=3, e=4'''), ('arguments',
r'''x=1j, /, *, y=2j'''),
r'''a=1, x=1j, /, *, y=2j, e=4''', r'''
arguments - ROOT 0,0..0,26
  ...
  .kwonlyargs[2]
   ...
   1] arg - 0,23..0,24
     .arg 'e'
  .kw_defaults[2]
   0] Constant 2j - 0,19..0,21
   1] Constant 4 - 0,25..0,26
  .defaults[2]
   0] Constant 1 - 0,2..0,3
   1] Constant 1j - 0,7..0,9
'''),

('', 2, 2, '_all', {}, ('arguments', r'''
  a=1,
  b=2,
  /,
  *,
...
arguments - ROOT 0,0..7,6
  ...
  .kwonlyargs[3]
   ...
   2] arg - 7,2..7,3
     .arg 'e'
  .kw_defaults[3]
   0] Constant 2j - 5,4..5,6
   1] Constant 3 - 6,4..6,5
   2] Constant 4 - 7,4..7,5
  .defaults[3]
   0] Constant 1 - 0,4..0,5
   1] Constant 2 - 1,4..1,5
   2] Constant 1j - 2,4..2,6
'''),

('', 2, 2, '_all', {}, ('arguments',
r'''a=1, b=2, /, *, d=3, e=4'''), ('arguments',
r'''x=1j, /, *, y=2j'''),
r'''a=1, b=2, x=1j, /, *, y=2j, d=3, e=4''', r'''
arguments - ROOT 0,0..0,36
  .posonlyargs[3]
   0] arg - 0,0..0,1
     .arg 'a'
   1] arg - 0,5..0,6
  ...
  .kwonlyargs[3]
   ...
   2] arg - 0,33..0,34
     .arg 'e'
  .kw_defaults[3]
   0] Constant 2j - 0,24..0,26
   1] Constant 3 - 0,30..0,31
   2] Constant 4 - 0,35..0,36
  .defaults[3]
   0] Constant 1 - 0,2..0,3
...
r'''a=1, b=2, /, *, d=3, e=4'''), ('arguments',
r'''x=1j, /, *, y=2j'''),
r'''a=1, x=1j, /, *, y=2j, d=3, e=4''', r'''
arguments - ROOT 0,0..0,31
  .posonlyargs[2]
   0] arg - 0,0..0,1
     .arg 'a'
   1] arg - 0,5..0,6
  ...
  .kw_defaults[3]
   0] Constant 2j - 0,19..0,21
   1] Constant 3 - 0,25..0,26
   2] Constant 4 - 0,30..0,31
  .defaults[2]
   0] Constant 1 - 0,2..0,3
   1] Constant 1j - 0,7..0,9
'''),
...
('', 0, 1, 'patterns', {}, ('pattern',
r'''call(a, b, c=d, d=e)'''), (None,
r'''x,'''),
r'''call(x, b, c=d, d=e)''', r'''
MatchClass - ROOT 0,0..0,20
  .cls Name 'call' Load - 0,0..0,4
  .patterns[2]
   0] MatchAs - 0,5..0,6
     .name 'x'
...
r'''cls(a, b, c=d, e=f)'''), ('_pattern_attrlikes',
r'''x'''),
r'''**NodeError('non-keyword pattern cannot follow keyword pattern')**'''),

('', 0, 'end', '_attrs', {}, ('MatchClass',
r'''cls(a, b, c=d, e=f)'''), ('_pattern_attrlikes',
r'''x'''),
r'''cls(x)''', r'''
MatchClass - ROOT 0,0..0,6
...
r'''cls(a, b, c=d, e=f)'''), ('_pattern_attrlikes',
r'''x, y=z'''),
r'''cls(a, x, y=z, c=d, e=f)''', r'''
MatchClass - ROOT 0,0..0,24
  .cls Name 'cls' Load - 0,0..0,3
  .patterns[2]
   0] MatchAs - 0,4..0,5
     .name 'a'
...
('', 0, 4, '_attrs', {}, ('_pattern_attrlikes',
r'''a, b, c=d, e=f'''), (None,
r'''**DEL**'''),
r'''''',
r'''_pattern_attrlikes - ROOT 0,0..0,0'''),

('', 1, 2, '_attrs', {}, ('_pattern_attrlikes',
r'''a, b, c=d, e=f'''), (None,
r'''**DEL**'''),
r'''a, c=d, e=f''', r'''
_pattern_attrlikes - ROOT 0,0..0,11
...
('', 0, 'end', '_attrs', {}, ('_pattern_attrlikes',
r'''a, b, c=d, e=f'''), ('_pattern_attrlikes',
r'''x'''),
r'''x''', r'''
_pattern_attrlikes - ROOT 0,0..0,1
...
r'''x, y=z'''),
r'''a, b, x, y=z, e=f''', r'''
_pattern_attrlikes - ROOT 0,0..0,17
  .patterns[3]
   0] MatchAs - 0,0..0,1
     .name 'a'
   1] MatchAs - 0,3..0,4
...
'one_True_to_arguments': [  # ................................................................................

('', 0, 'end', None, {'one': True}, ('arguments',
r'''a=1, /, b=2, *c, d=3, **e'''), ('arguments',
r'''x=0'''),
r'''x=0''', r'''
arguments - ROOT 0,0..0,3
  .args[1]
...
'one_True_to__pattern_attrlikes': [  # ................................................................................
...
('', 0, 'end', 'args', {'_ver': 12, 'one': True}, ('Call',
r'''call(a)'''), ('_type_params', r'''
