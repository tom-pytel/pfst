...
PARSE_TESTS = [
    ...
    ('all',               FST._parse_expr_all,          Starred,          '*not a'),
    ('all',               FST._parse_stmt,              AnnAssign,        'a:b'),
    ('all',               FST._parse_expr_all,          Slice,            'a:b:c'),
    ('all',               FST._parse_pattern,           MatchAs,          '1 as a'),
    ('all',               FST._parse_arguments,         arguments,        'a: list[str], /, b: int = 1, *c, d=100, **e'),
    ('all',               FST._parse_arguments_lambda,  arguments,        'a, /, b, *c, d=100, **e'),
    ('all',               FST._parse_arguments,         arguments,        '**a: dict'),
    ('all',               FST._parse_pattern,           MatchSequence,    '*a, b as c'),
    ('all',               FST._parse_comprehension,     comprehension,    'for i in range(5) if i'),
    ('all',               FST._parse_withitem,          withitem,         'f(**a) as b'),
    ('all',               FST._parse_operator,          Mult,             '*'),
    ('all',               FST._parse_augop,             Mult,             '*='),
    ('all',               FST._parse_cmpop,             Gt,               '>'),
    ('all',               FST._parse_boolop,            And,              'and'),
    ('all',               FST._parse_unaryop,           Invert,           '~'),
    ...
    ('ExceptHandlers',    FST._parse_ExceptHandlers,    IndentationError, ' except Exception: pass\nexcept: pass'),
    ...
    ('match_cases',       FST._parse_match_cases,       IndentationError, ' case None: pass\ncase 1: pass'),
