...
opts.ignore_module = [mod.strip()
    ...
    def test_match_pat_repr(self):
        ...
        self.assertEqual("MCB(TestFST.test_match_pat_repr)", repr(MCB(TestFST.test_match_pat_repr)))
        self.assertEqual("MCB(TestFST.test_match_pat_repr, fail_obj='fail')", repr(MCB(TestFST.test_match_pat_repr, fail_obj='fail')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr)", repr(MCB(cb=TestFST.test_match_pat_repr)))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, fail_obj='fail')", repr(MCB(cb=TestFST.test_match_pat_repr, fail_obj='fail')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, tag_ret=True)", repr(MCB(cb=TestFST.test_match_pat_repr, tag_ret=True)))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_obj='fail')", repr(MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_obj='fail')))
        self.assertEqual("MCB(TestFST.test_match_pat_repr, static1='stag1', static2='stag2')", repr(MCB(TestFST.test_match_pat_repr, static1='stag1', static2='stag2')))
        self.assertEqual("MCB(TestFST.test_match_pat_repr, fail_obj='fail', static1='stag1', static2='stag2')", repr(MCB(TestFST.test_match_pat_repr, fail_obj='fail', static1='stag1', static2='stag2')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, static1='stag1', static2='stag2')", repr(MCB(cb=TestFST.test_match_pat_repr, static1='stag1', static2='stag2')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, fail_obj='fail', static1='stag1', static2='stag2')", repr(MCB(cb=TestFST.test_match_pat_repr, fail_obj='fail', static1='stag1', static2='stag2')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, static1='stag1', static2='stag2')", repr(MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, static1='stag1', static2='stag2')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_obj='fail', static1='stag1', static2='stag2')", repr(MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_obj='fail', static1='stag1', static2='stag2')))
