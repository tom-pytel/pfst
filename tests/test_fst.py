...
opts.ignore_module = [mod.strip()
    ...
    def test_match_pat_repr(self):
        ...
        self.assertEqual("MCB(TestFST.test_match_pat_repr, fail_val='fail')", repr(MCB(TestFST.test_match_pat_repr, fail_val='fail')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr)", repr(MCB(cb=TestFST.test_match_pat_repr)))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, fail_val='fail')", repr(MCB(cb=TestFST.test_match_pat_repr, fail_val='fail')))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, tag_ret=True)", repr(MCB(cb=TestFST.test_match_pat_repr, tag_ret=True)))
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_val='fail')", repr(MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_val='fail')))
        ...
        self.assertEqual("MCB(TestFST.test_match_pat_repr, fail_val='fail', static1='stag1', static2='stag2')", repr(MCB(TestFST.test_match_pat_repr, fail_val='fail', static1='stag1', static2='stag2')))
        ...
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, fail_val='fail', static1='stag1', static2='stag2')", repr(MCB(cb=TestFST.test_match_pat_repr, fail_val='fail', static1='stag1', static2='stag2')))
        ...
        self.assertEqual("MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_val='fail', static1='stag1', static2='stag2')", repr(MCB(cb=TestFST.test_match_pat_repr, tag_ret=True, fail_val='fail', static1='stag1', static2='stag2')))
