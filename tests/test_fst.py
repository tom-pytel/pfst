...
PARSE_TESTS = [
    ...
    ('alias_dotted',      extparse.parse_alias_dotted,      alias,            'a'),
    ('alias_dotted',      extparse.parse_alias_dotted,      alias,            'a.b'),
    ('alias_dotted',      extparse.parse_alias_dotted,      SyntaxError,      '*'),
    ('alias_dotted',      extparse.parse_alias_dotted,      ParseError,       'a, b'),
    ('alias_dotted',      extparse.parse_alias_dotted,      alias,            'a as c'),
    ('alias_dotted',      extparse.parse_alias_dotted,      alias,            'a.b as c'),
    ('alias_dotted',      extparse.parse_alias_dotted,      SyntaxError,      '* as c'),

    ('alias_star',        extparse.parse_alias_star,        alias,            'a'),
    ('alias_star',        extparse.parse_alias_star,        SyntaxError,      'a.b'),
    ('alias_star',        extparse.parse_alias_star,        alias,            '*'),
    ('alias_star',        extparse.parse_alias_star,        ParseError,       'a, b'),
    ('alias_star',        extparse.parse_alias_star,        alias,            'a as c'),
    ('alias_star',        extparse.parse_alias_star,        SyntaxError,      'a.b as c'),
    ('alias_star',        extparse.parse_alias_star,        SyntaxError,      '* as c'),
    ...
    ('alias_dotted',      extparse.parse_alias_dotted,      alias,            ' a.b  # tail'),
    ('alias_star',        extparse.parse_alias_star,        alias,            ' *  # tail'),
...
'''.strip(), 'exec')
        ...
        CODE_ASES = [
            ...
            (code_as_alias_dotted, 'body[0].names[0]', 'import a'),
            (code_as_alias_dotted, 'body[0].names[0]', 'import a.b'),
            (code_as_alias_star, 'body[0].names[0]', 'from a import b'),
            (code_as_alias_star, 'body[0].names[0]', 'from a import *'),
...
'''.strip(), 'exec')
    ...
    def test_code_as_sanitize(self):
        CODE_ASES = [
            ...
            (code_as_alias_dotted, 'a'),
            (code_as_alias_dotted, 'a.b'),
            (code_as_alias_star, 'b'),
            (code_as_alias_star, '*'),
            (code_as_withitem, 'a'),
    ...
    def test_code_as_from_ast(self):
        for mode, func, res, src in PARSE_TESTS:
            ...
            try:
                if func in (extparse.parse_ExceptHandlers, extparse.parse_match_cases, extparse.parse_type_params,
