...
'''.strip(), 'exec')
    ...
    def test_code_as_coerce(self):
        ...
        cases = [
            ...
            (code_as_expr, (_Assign_targets, 'a = b = c ='),
                "**SyntaxError**",  # src
                "**NodeError('expecting expression (standard), got _Assign_targets, could not coerce, FST has incompatible source')**",  # FST
                (Tuple, '(a, b, c)')),  # AST
            (code_as_expr, (_decorator_list, '@a\n@b\n@c'),
                "**SyntaxError**",  # src
                "**NodeError('expecting expression (standard), got _decorator_list, could not coerce, FST has incompatible source')**",  # FST
                (Tuple, '(a, b, c)')),  # AST
            (code_as_expr, (_comprehension_ifs, 'if a if b if c'),
                "**SyntaxError**",  # src
                "**NodeError('expecting expression (standard), got _comprehension_ifs, could not coerce, FST has incompatible source')**",  # FST
                (Tuple, '(a, b, c)')),  # AST
            ...
            (code_as_expr, (_arglikes, 'a, b=c'),
                "**SyntaxError**",  # src
                "**NodeError('expecting expression (standard), got _arglikes, could not coerce, _arglikes has a keyword')**",  # FST
                "**NodeError('expecting expression (standard), got _arglikes, could not coerce, _arglikes has a keyword')**"),  # AST
            ...
            (code_as__arglikes, (_Assign_targets, 'a = \\\nb ='),
                '**SyntaxError**',
                "**NodeError('expecting _arglikes, got _Assign_targets, could not coerce')**",
                (_arglikes, 'a, b')),
            (code_as__arglikes, (_decorator_list, '\n@a\n@b\n'),
                '**SyntaxError**',
                "**NodeError('expecting _arglikes, got _decorator_list, could not coerce')**",
                (_arglikes, 'a, b')),
            (code_as__arglikes, (_comprehension_ifs, '\nif\na\nif\nb\n'),
                '**SyntaxError**',
                "**NodeError('expecting _arglikes, got _comprehension_ifs, could not coerce')**",
                (_arglikes, 'a, b')),
            ...
            (code_as__aliases, (_Assign_targets, 'a = \\\nb ='),
                '**SyntaxError**',
                "**NodeError('expecting _aliases, got _Assign_targets, could not coerce')**",
                (_aliases, 'a, b')),
            (code_as__aliases, (_decorator_list, '\n@a\n@b\n'),
                '**SyntaxError**',
                "**NodeError('expecting _aliases, got _decorator_list, could not coerce')**",
                (_aliases, 'a, b')),
            ...
            (code_as__aliases, (_comprehension_ifs, '\nif\na\nif\nb\n'),
                '**SyntaxError**',
                "**NodeError('expecting _aliases, got _comprehension_ifs, could not coerce')**",
                (_aliases, 'a, b')),
            ...
            (code_as__withitems, (_Assign_targets, 'a = \\\nb ='),
                '**SyntaxError**',
                "**NodeError('expecting _withitems, got _Assign_targets, could not coerce')**",
                (_withitems, 'a, b')),
            (code_as__withitems, (_decorator_list, '\n@a\n@b\n'),
                '**SyntaxError**',
                "**NodeError('expecting _withitems, got _decorator_list, could not coerce')**",
                (_withitems, 'a, b')),
            ...
            (code_as__withitems, (_comprehension_ifs, '\nif\na\nif\nb\n'),
                '**SyntaxError**',
                "**NodeError('expecting _withitems, got _comprehension_ifs, could not coerce')**",
                (_withitems, 'a, b')),
        ...
        if PYGE12:
            cases.extend([
                ...
                (code_as__type_params, (_Assign_targets, 'a = \\\nb ='),
                    '**SyntaxError**',
                    "**NodeError('expecting _type_params, got _Assign_targets, could not coerce')**",
                    (_type_params, 'a, b')),
                (code_as__type_params, (_decorator_list, '\n@a\n@b\n'),
                    '**SyntaxError**',
                    "**NodeError('expecting _type_params, got _decorator_list, could not coerce')**",
                    (_type_params, 'a, b')),
                ...
                (code_as__type_params, (_comprehension_ifs, '\nif\na\nif\nb\n'),
                    '**SyntaxError**',
                    "**NodeError('expecting _type_params, got _comprehension_ifs, could not coerce')**",
                    (_type_params, 'a, b')),
    ...
    def test_unmake__ast_coerce_to_expr(self):
        mode_and_src = [
            ...
            (_arglikes, 'a'),
            # (_comprehension_ifs, 'if a'),  # incompatible src for FST
            (arg, 'a'),
            (alias, 'a'),
            (_aliases, 'a'),
            (withitem, 'a'),
