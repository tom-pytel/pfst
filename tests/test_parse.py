...
from support import BaseCases, ParseCases, CoerceCases, assertRaises
...
PARSE_TESTS = [
    ...
    ('withitem',           px.parse_withitem,           ParseError,               'a,'),
    ('withitem',           px.parse_withitem,           SyntaxError,              '*a,'),
    ('withitem',           px.parse_withitem,           ParseError,               'a, b'),
    ...
    ('withitem',           px.parse_withitem,           withitem,                 '(a)'),
    ('withitem',           px.parse_withitem,           withitem,                 '(i for i in j)'),
    ('withitem',           px.parse_withitem,           SyntaxError,              'i for i in j'),
    ...
    ('withitem',           px.parse_withitem,           ParseError,               ' a as b,  # tail'),
...
class TestParse(unittest.TestCase):
    ...
    def test_parse_w_trailing_semicolon(self):
        self.assertIsInstance(px.parse('a'), Name)
        self.assertIsInstance(px.parse('a;'), Expr)
        self.assertIsInstance(px.parse_all('a'), Name)
        self.assertIsInstance(px.parse_all('a;'), Expr)
        self.assertIsInstance(px.parse_strict('a'), Name)
        self.assertIsInstance(px.parse_strict('a;'), Expr)
        self.assertIsInstance(px.parse_Module('a;'), Module)
        assertRaises(SyntaxError, px.parse_Expression, 'a;')
        self.assertIsInstance(px.parse_Interactive('a;'), Interactive)
        self.assertIsInstance(px.parse_stmt('a;'), Expr)
        self.assertIsInstance(px.parse_stmts('a;'), Module)
        self.assertIsInstance(px.parse_ExceptHandler('except: pass;'), ExceptHandler)
        self.assertIsInstance(px.parse__ExceptHandlers('except: pass;'), _ExceptHandlers)
        self.assertIsInstance(px.parse_match_case('case _: pass;'), match_case)
        self.assertIsInstance(px.parse__match_cases('case _: pass;'), _match_cases)
        assertRaises(SyntaxError('invalid syntax'), px.parse_expr, 'a;')
        assertRaises(SyntaxError, px.parse_expr_all, 'a;')
        assertRaises(SyntaxError, px.parse_expr_arglike, 'a;')
        assertRaises(SyntaxError, px.parse_expr_slice, 'a;')
        assertRaises(SyntaxError('invalid syntax'), px.parse_Tuple_elt, 'a;')
        assertRaises(SyntaxError, px.parse_Tuple, '(a,);')
        assertRaises(SyntaxError, px.parse_List, '[a];')
        assertRaises(SyntaxError, px.parse_Set, '{a};')
        assertRaises(SyntaxError, px.parse__Assign_targets, 'a=;')
        assertRaises(SyntaxError, px.parse__decorator_list, '@a;')
        assertRaises(SyntaxError, px.parse__arglike, 'a;')
        assertRaises(SyntaxError, px.parse__arglikes, 'a;')
        assertRaises(SyntaxError, px.parse_boolop, 'a;')
        assertRaises(SyntaxError, px.parse_operator, '+;')
        assertRaises(SyntaxError, px.parse_unaryop, '+;')
        assertRaises(SyntaxError, px.parse_cmpop, '==;')
        assertRaises(SyntaxError, px.parse_comprehension, 'for i in j;')
        assertRaises(SyntaxError, px.parse__comprehensions, 'for i in j;')
        assertRaises(SyntaxError, px.parse__comprehension_ifs, 'if a;')
        assertRaises(SyntaxError, px.parse_arguments, 'a;')
        assertRaises(SyntaxError, px.parse_arguments_lambda, 'a;')
        assertRaises(SyntaxError, px.parse_arg, 'a;')
        assertRaises(SyntaxError, px.parse_keyword, 'a=b;')
        assertRaises(SyntaxError('invalid syntax'), px.parse_alias, 'a;')
        assertRaises(SyntaxError('invalid syntax'), px.parse__aliases, 'a;')
        assertRaises(SyntaxError('invalid syntax'), px.parse_Import_name, 'a;')
        assertRaises(SyntaxError('invalid syntax'), px.parse__Import_names, 'a;')
        assertRaises(SyntaxError('invalid syntax'), px.parse_ImportFrom_name, 'a;')
        assertRaises(SyntaxError('invalid syntax'), px.parse__ImportFrom_names, 'a;')
        assertRaises(SyntaxError, px.parse_withitem, 'a;')
        assertRaises(SyntaxError, px.parse__withitems, 'a;')
        assertRaises(SyntaxError, px.parse_pattern, 'a;')
        assertRaises(SyntaxError, px.parse__pattern_attrlikes, 'a;')
        assertRaises(SyntaxError, px.parse_type_param, 'a;')
        assertRaises(SyntaxError, px.parse__type_params, 'a;')
        assertRaises(SyntaxError, px.parse__expr_arglikes, 'a;')
        assertRaises(SyntaxError, px.parse__Dict_maybe_undelimited, 'a: b;')
        assertRaises(SyntaxError, px.parse__MatchMapping_maybe_undelimited, '1: a;')
        assertRaises(SyntaxError, px.parse__BoolOp_dangling_left, 'or a;')
        assertRaises(SyntaxError, px.parse__BoolOp_dangling_right, 'a or;')
        assertRaises(SyntaxError, px.parse__Compare_dangling_left, '< a;')
        assertRaises(SyntaxError, px.parse__Compare_dangling_right, 'a <;')
    ...
    def test_code_as_coerce(self):
        ...
        cases = [
            ...
            (code_as_pattern, (Constant, '(1)'),
                (MatchValue, '(1)'),
                (MatchValue, '1')),
            (code_as_pattern, (Constant, '(1j)'),
                (MatchValue, '(1j)'),
                (MatchValue, '1j')),
            (code_as_pattern, (UnaryOp, '-(1)'),
                "**SyntaxError**",
                (MatchValue, '-1'),
                (MatchValue, '-1')),
            (code_as_pattern, (UnaryOp, '-(1j)'),
                "**SyntaxError**",
                (MatchValue, '-1j'),
                (MatchValue, '-1j')),
            (code_as_pattern, (BinOp, '(1)+(1j)'),
                "**SyntaxError**",
                (MatchValue, '1+1j'),
                (MatchValue, '1 + 1j')),
            (code_as_pattern, (BinOp, '-(1)-(1j)'),
            ...
            (code_as__pattern_attrlikes, (Module, '( a )'),
                ...
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (Interactive, '( a )'),
                (_pattern_attrlikes, '( a )'),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (Expression, '( a )'),
                (_pattern_attrlikes, '( a )'),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (Expr, '( a )'),
                (_pattern_attrlikes, '( a )'),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (Name, ' ( a ) '),
                (_pattern_attrlikes, ' ( a ) '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (Constant, ' ( ... ) '),
                "**SyntaxError**",
                "**NodeError('expecting _pattern_attrlikes, got Constant, could not coerce')**",
                "**NodeError('expecting _pattern_attrlikes, got Constant, could not coerce')**",),
            (code_as__pattern_attrlikes, (Constant, ' ( True ) '),
                (_pattern_attrlikes, ' ( True ) '),
                (_pattern_attrlikes, 'True')),
            (code_as__pattern_attrlikes, (Constant, ' ( False ) '),
                (_pattern_attrlikes, ' ( False ) '),
                (_pattern_attrlikes, 'False')),
            (code_as__pattern_attrlikes, (Constant, ' ( None ) '),
                (_pattern_attrlikes, ' ( None ) '),
                (_pattern_attrlikes, 'None')),
            (code_as__pattern_attrlikes, (Constant, '...'),
                "**SyntaxError**",
                "**NodeError('expecting _pattern_attrlikes, got Constant, could not coerce')**",
                "**NodeError('expecting _pattern_attrlikes, got Constant, could not coerce')**"),
            (code_as__pattern_attrlikes, (Constant, '(1)'),
                (_pattern_attrlikes, '(1)'),
                (_pattern_attrlikes, '1')),
            (code_as__pattern_attrlikes, (Constant, '(1j)'),
                (_pattern_attrlikes, '(1j)'),
                (_pattern_attrlikes, '1j')),
            (code_as__pattern_attrlikes, (UnaryOp, '-(1)'),
                "**SyntaxError**",
                (_pattern_attrlikes, '-1'),
                (_pattern_attrlikes, '-1')),
            (code_as__pattern_attrlikes, (UnaryOp, '-(1j)'),
                "**SyntaxError**",
                (_pattern_attrlikes, '-1j'),
                (_pattern_attrlikes, '-1j')),
            (code_as__pattern_attrlikes, (BinOp, '(1)+(1j)'),
                "**SyntaxError**",
                (_pattern_attrlikes, '1+1j'),
                (_pattern_attrlikes, '1 + 1j')),
            (code_as__pattern_attrlikes, (BinOp, '-(1)-(1j)'),
                "**SyntaxError**",
                (_pattern_attrlikes, '-1-1j'),
            ...
            (code_as__pattern_attrlikes, (BinOp, '-1-1j'),
                ...
                (_pattern_attrlikes, '-1-1j'),
                (_pattern_attrlikes, '-1 - 1j')),
            (code_as__pattern_attrlikes, (UnaryOp, '-(1-1j)'),
                "**SyntaxError**",
                "**NodeError('expecting _pattern_attrlikes, got UnaryOp, could not coerce')**",
                "**NodeError('expecting _pattern_attrlikes, got UnaryOp, could not coerce')**"),
            (code_as__pattern_attrlikes, (Attribute, ' ( ( a )\n.\nb ) '),
                "**SyntaxError**",
                (_pattern_attrlikes, ' ( a\n.\nb ) '),
                (_pattern_attrlikes, 'a.b')),
            (code_as__pattern_attrlikes, (Starred, ' *\na '),
                "**SyntaxError**",
                "**NodeError('expecting _pattern_attrlikes, got Starred, could not coerce')**",
                "**NodeError('expecting _pattern_attrlikes, got Starred, could not coerce')**"),
            (code_as__pattern_attrlikes, (Starred, ' *(\na) '),
                "**SyntaxError**",
                "**NodeError('expecting _pattern_attrlikes, got Starred, could not coerce')**",
                "**NodeError('expecting _pattern_attrlikes, got Starred, could not coerce')**"),
            (code_as__pattern_attrlikes, (arg, ' a '),
                (_pattern_attrlikes, ' a '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (alias, ' a '),
                (_pattern_attrlikes, ' a '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (withitem, ' ( a ) '),
                (_pattern_attrlikes, ' ( a ) '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (Dict, '{((a).b): c, **r}'),
                "**SyntaxError**",
                (_pattern_attrlikes, '{a.b: c, **r}'),
                (_pattern_attrlikes, '{a.b: c, **r}')),
            (code_as__pattern_attrlikes, (Call, '((u).v)((a), b=(c))'),
                "**SyntaxError**",
                (_pattern_attrlikes, 'u.v((a), b=(c))'),
                (_pattern_attrlikes, 'u.v(a, b=c)')),
            (code_as__pattern_attrlikes, (BinOp, 'a | b'), (_pattern_attrlikes, 'a | b')),
            (code_as__pattern_attrlikes, (BinOp, 'a | b | c'), (_pattern_attrlikes, 'a | b | c')),
            (code_as__pattern_attrlikes, (BinOp, '(a | b) | c'),
                (_pattern_attrlikes, '(a | b) | c'),
                (_pattern_attrlikes, '(a | b) | c'),
                (_pattern_attrlikes, 'a | b | c')),
            (code_as__pattern_attrlikes, (BinOp, 'a | (b | c)'), (_pattern_attrlikes, 'a | (b | c)')),
            (code_as__pattern_attrlikes, (BinOp, '(a | (b | c)) | d'),
                (_pattern_attrlikes, '(a | (b | c)) | d'),
                (_pattern_attrlikes, '(a | (b | c)) | d'),
                (_pattern_attrlikes, 'a | (b | c) | d')),
            (code_as__pattern_attrlikes, (BinOp, 'a | ((b | c) | d)'),
                (_pattern_attrlikes, 'a | ((b | c) | d)'),
            ...
            (code_as__pattern_attrlikes, (BinOp, '(a | b | c) | d'),
                ...
                (_pattern_attrlikes, '(a | b | c) | d'),
                (_pattern_attrlikes, 'a | b | c | d')),
            (code_as__pattern_attrlikes, (BinOp, 'a | (b | c | d)'), (_pattern_attrlikes, 'a | (b | c | d)')),
            (code_as__pattern_attrlikes, (BinOp, 'a | (b | c) | d'), (_pattern_attrlikes, 'a | (b | c) | d')),
            (code_as__pattern_attrlikes, (BinOp, 'a | (b | (c | d) | e) | f'), (_pattern_attrlikes, 'a | (b | (c | d) | e) | f')),
            (code_as__pattern_attrlikes, (BinOp, 'a + b'),
                "**SyntaxError**",
                "**NodeError('expecting _pattern_attrlikes, got BinOp, could not coerce')**",
                "**NodeError('expecting _pattern_attrlikes, got BinOp, could not coerce')**"),

            (code_as__pattern_attrlikes, (Tuple, ' a\n, '),
                (_pattern_attrlikes, ' a\n, '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (List, ' [\na\n] '),
                (_pattern_attrlikes, ' [\na\n] '),
                (_pattern_attrlikes, '\na\n'),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (Set, ' {\na\n} '),
                "**SyntaxError**",
                (_pattern_attrlikes, '\na\n'),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (_Assign_targets, ' a \\\n= '),
                "**SyntaxError**",
                (_pattern_attrlikes, ' a '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (_decorator_list, '@ \\\n a '),
                "**SyntaxError**",
                (_pattern_attrlikes, 'a '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (_comprehension_ifs, ' \nif\n a '),
                "**SyntaxError**",
                (_pattern_attrlikes, ' \na '),
                (_pattern_attrlikes, 'a')),
            (code_as__pattern_attrlikes, (arguments, ' \n*\n a '),
                "**SyntaxError**",
                "**NodeError('expecting _pattern_attrlikes, got arguments, could not coerce')**",
                "**NodeError('expecting _pattern_attrlikes, got arguments, could not coerce')**"),
            (code_as__pattern_attrlikes, (_aliases, ' \n a\n '),
                (_pattern_attrlikes, ' \n a\n '),
                (_pattern_attrlikes, 'a')),
