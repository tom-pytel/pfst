...
class TestMatch(unittest.TestCase):
    ...
    def test_match_pat_repr(self):
        ...
        self.assertEqual("MMAYBE('pat')", repr(MMAYBE('pat')))
        self.assertEqual("MMAYBE(pat_tag='pat')", repr(MMAYBE(pat_tag='pat')))
        self.assertEqual("MMAYBE('pat', static1='stag1', static2='stag2')", repr(MMAYBE('pat', static1='stag1', static2='stag2')))
        self.assertEqual("MMAYBE(pat_tag='pat', static1='stag1', static2='stag2')", repr(MMAYBE(pat_tag='pat', static1='stag1', static2='stag2')))
        ...
        self.assertEqual("MQOPT('pat')", repr(MQOPT('pat')))
        self.assertEqual("MQOPT(pat_tag='pat')", repr(MQOPT(pat_tag='pat')))
        self.assertEqual("MQOPT('pat', static1='stag1', static2='stag2')", repr(MQOPT('pat', static1='stag1', static2='stag2')))
        self.assertEqual("MQOPT(pat_tag='pat', static1='stag1', static2='stag2')", repr(MQOPT(pat_tag='pat', static1='stag1', static2='stag2')))
    ...
    def test_match_FSTMatch(self):
        ...
        self.assertIs(FST('a').match(M(Name('a'), __tag__=True))['__noexist__'], NotSet)
    ...
    def test_match_M(self):
        ...
        self.assertEqual("<FSTMatch <FunctionDef ROOT 0,0..0,13>>", str(MFunctionDef(returns=MMAYBE('int')).match(FST('def f(): pass'))))
        self.assertEqual("<FSTMatch <FunctionDef ROOT 0,0..0,20>>", str(MFunctionDef(returns=MMAYBE('int')).match(FST('def f() -> int: pass'))))
        self.assertEqual("None", str(MFunctionDef(returns=MMAYBE('int')).match(FST('def f() -> str: pass'))))
        self.assertEqual("<FSTMatch <FunctionDef ROOT 0,0..0,13> {'t': []}>", str(MFunctionDef(returns=MMAYBE(t='int')).match(FST('def f(): pass'))))
        self.assertEqual("<FSTMatch <FunctionDef ROOT 0,0..0,20> {'t': <Name 0,11..0,14>}>", str(MFunctionDef(returns=MMAYBE(t='int')).match(FST('def f() -> int: pass'))))
        self.assertEqual("<FSTMatch <FunctionDef ROOT 0,0..0,20> {'m': <Name 0,11..0,14>, 't': <Name 0,11..0,14>}>", str(MFunctionDef(returns=MMAYBE(t=M(m='int'))).match(FST('def f() -> int: pass'))))

        p = MFunctionDef(returns=MMAYBE(t='int'))
        f = FST('def f() -> int: pass')
        m = p.match(f)
        self.assertIs(m['t'], f.returns)

        p = MFunctionDef(returns=MMAYBE(t=M(m='int')))
        f = FST('def f() -> int: pass')
        m = p.match(f)
        self.assertIs(m['t'], f.returns)
    ...
    def test_match_quantifiers(self):
        ...
        for kls, args in [
            ...
            assertRaises(error, kls, MQOPT, *args)
            assertRaises(error, kls, MQOPT.NG, *args)
        ...
        for kls, args in [
            ...
            assertRaises(error, kls, [MQN([MQOPT], 1)], *args)
            assertRaises(error, kls, [MQN([MQOPT.NG], 1)], *args)
        ...
        self.assertEqual("<FSTMatch <Nonlocal ROOT 0,0..0,17> {'t': [<FSTMatch <<Nonlocal ROOT 0,0..0,17>.names[0]> {'r': <re.Match object; span=(0, 3), match='abc'>}>, <FSTMatch <<Nonlocal ROOT 0,0..0,17>.names[1]> {'r': <re.Match object; span=(0, 3), match='bcd'>}>]}>", str(m))
        ...
        self.assertEqual("<FSTMatch <List ROOT 0,0..0,9> {'h': [<FSTMatch <Name 0,1..0,2>>]}>", str(MList(elts=[MQOPT(h='a'), MQSTAR]).match(f)))
        self.assertEqual("<FSTMatch <List ROOT 0,0..0,9> {'h': []}>", str(MList(elts=[MQOPT.NG(h='a'), MQSTAR]).match(f)))
        self.assertEqual("None", str(MList(elts=[MQOPT(h='a'), ...]).match(f)))
        self.assertEqual("None", str(MList(elts=[MQOPT.NG(h='a'), ...]).match(f)))
        self.assertEqual("<FSTMatch <List ROOT 0,0..0,9> {'h': [<FSTMatch <Name 0,1..0,2>>]}>", str(MList(elts=[MQOPT.NG(h='a'), ..., ...]).match(f)))
        self.assertEqual("<FSTMatch <List ROOT 0,0..0,9> {'h': []}>", str(MList(elts=[MQOPT.NG(h='a'), ..., ..., ...]).match(f)))
...
<FSTMatch <List ROOT 0,0..0,15> {'es': [<FSTMatch <Name 0,1..0,2> {'cb': <Name 0,1..0,2>}>, <FSTMatch <Name 0,4..0,5> {'cb': <Name 0,4..0,5>}>, <FSTMatch <Name 0,7..0,8> {'cb': <Name 0,7..0,8>}>, <FSTMatch <Name 0,10..0,11> {'cb': <Name 0,10..0,11>}>], 'static1': True, 'static2': False}>
    ...
    def test_match_AST(self):
        ...
        self.assertEqual("<FSTMatch Module(body=[Expr(value=Name(id='a'))], type_ignores=[]) {'t': Expr(value=Name(id='a'))}>", str(MModule(body=[MMAYBE(t=...)]).match(tgt_mod)))
        self.assertEqual("<FSTMatch Module(body=[Expr(value=Name(id='a'))], type_ignores=[]) {'t': [Expr(value=Name(id='a'))]}>", str(MModule(body=MMAYBE(t=[...])).match(tgt_mod)))
        self.assertEqual("<FSTMatch Module(body=[Expr(value=Name(id='a'))], type_ignores=[]) {'t': Module(body=[Expr(value=Name(id='a'))], type_ignores=[])}>", str(MMAYBE(t=MModule(body=[...])).match(tgt_mod)))
        self.assertEqual("<FSTMatch List(elts=[Name(id='a')]) {'t': Name(id='a')}>", str(MList(elts=[MMAYBE(t=...)]).match(tgt_list)))
        self.assertEqual("<FSTMatch List(elts=[Name(id='a')]) {'t': [Name(id='a')]}>", str(MList(elts=MMAYBE(t=[...])).match(tgt_list)))
        self.assertEqual("<FSTMatch List(elts=[Name(id='a')]) {'t': List(elts=[Name(id='a')])}>", str(MMAYBE(t=MList(elts=[...])).match(tgt_list)))
    ...
    def test_match_FST(self):
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[0]>}>", str(MDict(_all=[M(t=...)]).match(tgt_dict)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(Marguments(_all=[M(t=...)]).match(tgt_arguments)))
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[0]>}>", str(MDict(_all=[MNOT(t='NO!')]).match(tgt_dict)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(Marguments(_all=[MNOT(t='NO!')]).match(tgt_arguments)))
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[0]>}>", str(MDict(_all=[MOR(t=...)]).match(tgt_dict)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(Marguments(_all=[MOR(t=...)]).match(tgt_arguments)))
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[0]>}>", str(MDict(_all=[MAND(t=...)]).match(tgt_dict)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(Marguments(_all=[MAND(t=...)]).match(tgt_arguments)))
        ...
        self.assertEqual("<FSTMatch <Module ROOT 0,0..0,1> {'t': <Expr 0,0..0,1>}>", str(MModule(body=[MMAYBE(t=...)]).match(tgt_mod)))

        self.assertEqual("<FSTMatch <Module ROOT 0,0..0,1> {'t': <<Module ROOT 0,0..0,1>.body>}>", str(MModule(body=MMAYBE(t=[...])).match(tgt_mod)))
        self.assertEqual("<FSTMatch <Module ROOT 0,0..0,1> {'t': <Module ROOT 0,0..0,1>}>", str(MMAYBE(t=MModule(body=[...])).match(tgt_mod)))
        self.assertEqual("<FSTMatch <List ROOT 0,0..0,3> {'t': <Name 0,1..0,2>}>", str(MList(elts=[MMAYBE(t=...)]).match(tgt_list)))
        self.assertEqual("<FSTMatch <List ROOT 0,0..0,3> {'t': <<List ROOT 0,0..0,3>.elts>}>", str(MList(elts=MMAYBE(t=[...])).match(tgt_list)))
        self.assertEqual("<FSTMatch <List ROOT 0,0..0,3> {'t': <List ROOT 0,0..0,3>}>", str(MMAYBE(t=MList(elts=[...])).match(tgt_list)))
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[0]>}>", str(MDict(_all=[MMAYBE(t=...)]).match(tgt_dict)))
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all>}>", str(MDict(_all=MMAYBE(t=[...])).match(tgt_dict)))
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <Dict ROOT 0,0..0,6>}>", str(MMAYBE(t=MDict(_all=[...])).match(tgt_dict)))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(Marguments(_all=[MMAYBE(t=...)]).match(tgt_arguments)))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all>}>", str(Marguments(_all=MMAYBE(t=[...])).match(tgt_arguments)))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <arguments ROOT 0,0..0,10>}>", str(MMAYBE(t=Marguments(_all=[...])).match(tgt_arguments)))
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[0]>}>", str(MDict(_all=[MCB(t=lambda t: t, tag_ret=True)]).match(tgt_dict)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(Marguments(_all=[MCB(t=lambda t: t, tag_ret=True)]).match(tgt_arguments)))
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[0]>, 'u': <<Dict ROOT 0,0..0,6>._all[0]>}>", str(MDict(_all=[MAND(M(t=...), MTAG(u='t'))]).match(tgt_dict)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>, 'u': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(Marguments(_all=[MAND(M(t=...), MTAG(u='t'))]).match(tgt_arguments)))
    ...
    def test_match_virtual_field_one_Dict(self):
        ...
        self.assertTrue(MDict(_all=[MDict([MMAYBE('a')], ['b'])]).match(FST('{a: b}')))
        self.assertTrue(MDict(_all=[MDict([MMAYBE('a')], ['b'])]).match(FST('{**b}')))
        self.assertFalse(MDict(_all=[MDict([MMAYBE('a')], ['b'])]).match(FST('{c: b}')))

        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,17> {'t': [<FSTMatch <<Dict ROOT 0,0..0,17>._all[0]>>, <FSTMatch <<Dict ROOT 0,0..0,17>._all[1]>>]}>", str(MDict(_all=[MQ(t=MDict(..., ['b']), min=0, max=None), MQSTAR]).match(FST('{a: b, **b, c: d}'))))
        self.assertEqual('[<<Dict ROOT 0,0..0,17>._all[0]>, <<Dict ROOT 0,0..0,17>._all[1]>]', str([m.matched for m in MDict(_all=[MQ(t=MDict(..., ['b']), min=0, max=None), MQSTAR]).match(FST('{a: b, **b, c: d}'))['t']]))
        ...
        self.assertEqual('[<Name 0,1..0,2>, None]', str([m['k'] for m in MDict(_all=[MQ(t=MDict([M(k=MMAYBE('a'))]), min=0, max=None), MQSTAR]).match(FST('{a: b, **b, c: d}'))['t']]))
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,12> {'t': <<Dict ROOT 0,0..0,12>._all[0]>, 'u': <<Dict ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('{1: a, 1: a}'))))
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,18> {'t': <<Dict ROOT 0,0..0,18>._all[0]>, 'u': <<Dict ROOT 0,0..0,18>._all[2]>}>", str(pat.match(FST('{1: a, 2: b, 1: a}'))))
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,16> {'t': <<Dict ROOT 0,0..0,16>._all[0]>, 'u': <<Dict ROOT 0,0..0,16>._all[2]>}>", str(pat.match(FST('{**a, 2: b, **a}'))))
    ...
    def test_match_virtual_field_one_MatchMapping(self):
        ...
        self.assertTrue(MMatchMapping(_all=[MMatchMapping([MMAYBE('1')], ['b'])]).match(FST('{1: b}', pattern)))
        self.assertFalse(MMatchMapping(_all=[MMatchMapping([MMAYBE('1')], ['b'])]).match(FST('{**b}', pattern)))
        self.assertFalse(MMatchMapping(_all=[MMatchMapping([MMAYBE('1')], ['b'])]).match(FST('{2: b}', pattern)))

        self.assertEqual("<FSTMatch <MatchMapping ROOT 0,0..0,11> {'t': [<FSTMatch <<MatchMapping ROOT 0,0..0,11>._all[0]>>]}>", str(MMatchMapping(_all=[MQ(t=MMatchMapping(..., ['b']), min=0, max=None), MQSTAR]).match(FST('{1: b, **b}', pattern))))
        self.assertEqual('[<<MatchMapping ROOT 0,0..0,11>._all[0]>]', str([m.matched for m in MMatchMapping(_all=[MQ(t=MMatchMapping(..., ['b']), min=0, max=None), MQSTAR]).match(FST('{1: b, **b}', pattern))['t']]))
        ...
        self.assertEqual('[<Constant 0,1..0,2>]', str([m['k'] for m in MMatchMapping(_all=[MQ(t=MMatchMapping([M(k=MMAYBE('1'))]), min=0, max=None), MQSTAR]).match(FST('{1: b, **b}', pattern))['t']]))
        ...
        self.assertEqual("<FSTMatch <MatchMapping ROOT 0,0..0,12> {'t': <<MatchMapping ROOT 0,0..0,12>._all[0]>, 'u': <<MatchMapping ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('{1: a, 1: a}', pattern))))
        self.assertEqual("<FSTMatch <MatchMapping ROOT 0,0..0,18> {'t': <<MatchMapping ROOT 0,0..0,18>._all[0]>, 'u': <<MatchMapping ROOT 0,0..0,18>._all[2]>}>", str(pat.match(FST('{1: a, 2: b, 1: a}', pattern))))
        ...
        self.assertEqual("<FSTMatch <MatchSequence ROOT 0,0..0,20> {'t': <<MatchMapping 0,1..0,6>._all[0]>, 'u': <<MatchMapping 0,8..0,19>._all[1]>}>", str(pat.match(FST('[{**b}, {1: a, **b}]', pattern))))
    ...
    def test_match_virtual_field_one_arguments(self):
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,7> {'t': <<arguments ROOT 0,0..0,7>._all[0]>}>", str(pat.match(FST('*a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[0]>}>", str(pat.match(FST('*a: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,13> {'t': <<arguments ROOT 0,0..0,13>._all[1]>}>", str(pat.match(FST('x, *a: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[1]>}>", str(pat.match(FST('x, *a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,13> {'t': <<arguments ROOT 0,0..0,13>._all[1]>}>", str(pat.match(FST('x, *b: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,13> {'t': <<arguments ROOT 0,0..0,13>._all[1]>}>", str(pat.match(FST('x, *a: str, y', arguments))))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,8> {'t': <<arguments ROOT 0,0..0,8>._all[0]>}>", str(pat.match(FST('**a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,11> {'t': <<arguments ROOT 0,0..0,11>._all[1]>}>", str(pat.match(FST('x, **a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,11> {'t': <<arguments ROOT 0,0..0,11>._all[1]>}>", str(pat.match(FST('x, **b: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,11> {'t': <<arguments ROOT 0,0..0,11>._all[1]>}>", str(pat.match(FST('x, **a: str', arguments))))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[0]>}>", str(pat.match(FST('*, a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[0]>}>", str(pat.match(FST('*, a: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,15> {'t': <<arguments ROOT 0,0..0,15>._all[1]>}>", str(pat.match(FST('x, *, a: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, *, a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,15> {'t': <<arguments ROOT 0,0..0,15>._all[1]>}>", str(pat.match(FST('x, *, b: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,15> {'t': <<arguments ROOT 0,0..0,15>._all[1]>}>", str(pat.match(FST('x, *, a: str, y', arguments))))
        self.assertFalse(pat.match(FST('x, *, c: int, y', arguments)))
        self.assertFalse(pat.match(FST('x, *, a: float, y', arguments)))
        self.assertFalse(pat.match(FST('*a: int', arguments)))
        self.assertFalse(pat.match(FST('**a: int', arguments)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,6> {'t': <<arguments ROOT 0,0..0,6>._all[0]>}>", str(pat.match(FST('a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[0]>}>", str(pat.match(FST('a: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, a: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[1]>}>", str(pat.match(FST('x, a: int', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, b: int, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, a: str, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[0]>}>", str(pat.match(FST('a: int, /', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[0]>}>", str(pat.match(FST('a: int, /, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,15> {'t': <<arguments ROOT 0,0..0,15>._all[1]>}>", str(pat.match(FST('x, a: int, /, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, a: int, /', arguments))))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,6> {'t': <<arguments ROOT 0,0..0,6>._all[0]>}>", str(pat.match(FST('*, a=1', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[0]>}>", str(pat.match(FST('*, a=1, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, *, a=1, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[1]>}>", str(pat.match(FST('x, *, a=1', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, *, b=1, y', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,12> {'t': <<arguments ROOT 0,0..0,12>._all[1]>}>", str(pat.match(FST('x, *, a=2, y', arguments))))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,6> {'t': <<arguments ROOT 0,0..0,6>._all[0]>}>", str(pat.match(FST('a=1, /', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,11> {'t': <<arguments ROOT 0,0..0,11>._all[0]>}>", str(pat.match(FST('a=1, /, y=0', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,14> {'t': <<arguments ROOT 0,0..0,14>._all[1]>}>", str(pat.match(FST('x, a=1, /, y=0', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[1]>}>", str(pat.match(FST('x, a=1, /', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,14> {'t': <<arguments ROOT 0,0..0,14>._all[1]>}>", str(pat.match(FST('x, b=1, /, y=0', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,14> {'t': <<arguments ROOT 0,0..0,14>._all[1]>}>", str(pat.match(FST('x, a=2, /, y=0', arguments))))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,3> {'t': <<arguments ROOT 0,0..0,3>._all[0]>}>", str(pat.match(FST('a=1', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,8> {'t': <<arguments ROOT 0,0..0,8>._all[0]>}>", str(pat.match(FST('a=1, y=0', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,11> {'t': <<arguments ROOT 0,0..0,11>._all[1]>}>", str(pat.match(FST('x, a=1, y=0', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,6> {'t': <<arguments ROOT 0,0..0,6>._all[1]>}>", str(pat.match(FST('x, a=1', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,11> {'t': <<arguments ROOT 0,0..0,11>._all[1]>}>", str(pat.match(FST('x, b=1, y=0', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,11> {'t': <<arguments ROOT 0,0..0,11>._all[1]>}>", str(pat.match(FST('x, a=2, y=0', arguments))))
        self.assertFalse(pat.match(FST('x, c=1, y=0', arguments)))
        self.assertFalse(pat.match(FST('x, a=3, y=0', arguments)))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,6> {'t': <<arguments ROOT 0,0..0,6>._all[0]>}>", str(pat.match(FST('*, a=1', arguments))))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,9> {'t': <<arguments ROOT 0,0..0,9>._all[0]>}>", str(pat.match(FST('*, a=1, y', arguments))))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,6> {'t': <<arguments ROOT 0,0..0,6>._all[0]>}>", str(pat.match(FST('a=x, /', arguments))))
        self.assertFalse(pat.match(FST('a=y, /', arguments)))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,3> {'t': <<arguments ROOT 0,0..0,3>._all[0]>}>", str(pat.match(FST('a=x', arguments))))
        self.assertFalse(pat.match(FST('a=y', arguments)))
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,6> {'t': <<arguments ROOT 0,0..0,6>._all[0]>}>", str(pat.match(FST('*, a=x', arguments))))
        self.assertFalse(pat.match(FST('*, a=y', arguments)))
        ...
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,23> {'t': <<arguments 0,6..0,16>._all[0]>, 'u': <arguments 1,6..1,16>}>", str(pat.match(FST('def f(a: int = 1): pass\ndef g(a: int = 1): pass'))))
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,26> {'t': <<arguments 0,6..0,16>._all[0]>, 'u': <arguments 1,6..1,19>}>", str(pat.match(FST('def f(a: int = 1): pass\ndef g(*, a: int = 1): pass'))))
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,26> {'t': <<arguments 0,6..0,16>._all[0]>, 'u': <arguments 1,6..1,19>}>", str(pat.match(FST('def f(a: int = 1): pass\ndef g(a: int = 1, /): pass'))))
        self.assertFalse(pat.match(FST('def f(a: int = 1): pass\ndef g(a: int = 2): pass')))
        self.assertFalse(pat.match(FST('def f(a: int = 1): pass\ndef g(b: int = 1): pass')))
        self.assertFalse(pat.match(FST('def f(a: int = 1): pass\ndef g(a: int): pass')))
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,19> {'t': <<arguments 0,6..0,12>._all[0]>, 'u': <arguments 1,6..1,12>}>", str(pat.match(FST('def f(a: int): pass\ndef g(a: int): pass'))))
        ...
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,23> {'t': <<arguments 0,6..0,19>._all[0]>, 'u': <arguments 1,6..1,16>}>", str(pat.match(FST('def f(*, a: int = 1): pass\ndef g(a: int = 1): pass'))))
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,26> {'t': <<arguments 0,6..0,19>._all[0]>, 'u': <arguments 1,6..1,19>}>", str(pat.match(FST('def f(*, a: int = 1): pass\ndef g(*, a: int = 1): pass'))))
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,26> {'t': <<arguments 0,6..0,19>._all[0]>, 'u': <arguments 1,6..1,19>}>", str(pat.match(FST('def f(*, a: int = 1): pass\ndef g(a: int = 1, /): pass'))))
        self.assertFalse(pat.match(FST('def f(*, a: int = 1): pass\ndef g(a: int = 2): pass')))
        self.assertFalse(pat.match(FST('def f(*, a: int = 1): pass\ndef g(b: int = 1): pass')))
        self.assertFalse(pat.match(FST('def f(*, a: int = 1): pass\ndef g(*, a: int): pass')))
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,22> {'t': <<arguments 0,6..0,15>._all[0]>, 'u': <arguments 1,6..1,15>}>", str(pat.match(FST('def f(*, a: int): pass\ndef g(*, a: int): pass'))))
        self.assertFalse(pat.match(FST('def f(*, a: int): pass\ndef g(*, a: int = 1): pass')))
...
def g(a: int = 1, /, a: int = 1, *, a: int = 1): pass
        ...
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,53> {'t': <<arguments 0,6..0,16>._all>, 'u': [<FSTMatch <<arguments 1,6..1,46>._all[0]>>, <FSTMatch <<arguments 1,6..1,46>._all[1]>>, <FSTMatch <<arguments 1,6..1,46>._all[2]>>]}>", str(pat.match(f)))

        pat = MModule(body=[
            MFunctionDef(args=Marguments(_all=M(t=...))),
            MFunctionDef(args=Marguments(_all=[MQPLUS(M(u=MTAG('t')))])),
        ])
        self.assertEqual("<FSTMatch <Module ROOT 0,0..1,53> {'t': <<arguments 0,6..0,16>._all>, 'u': <<arguments 1,6..1,46>._all[2]>}>", str(pat.match(f)))
...
def g(b: int = 1, /, a: int = 1, *, a: int = 1): pass
    ...
    def test_match_coverage(self):
        ...
        self.assertTrue(MAssign(value=MConstant(MMAYBE(1))).match(f))
        self.assertFalse(MAssign(value=MConstant(MMAYBE(2))).match(f))
        self.assertTrue(MAssign(value=(MMAYBE(M(t=MConstant), st='static'))).match(f))
