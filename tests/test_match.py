...
<FSTMatch <List ROOT 0,0..0,15> {'es': [<FSTMatch <Name 0,1..0,2> {'cb': <Name 0,1..0,2>}>, <FSTMatch <Name 0,4..0,5> {'cb': <Name 0,4..0,5>}>, <FSTMatch <Name 0,7..0,8> {'cb': <Name 0,7..0,8>}>, <FSTMatch <Name 0,10..0,11> {'cb': <Name 0,10..0,11>}>], 'static1': True, 'static2': False}>
    ...
    def test_match_FST(self):
        ...
        self.assertEqual("<FSTMatch <Dict ROOT 0,0..0,6> {'t': <<Dict ROOT 0,0..0,6>._all[:1]>}>", str(MDict(_all=[MMAYBE(t=...)]).match(tgt_dict)))
        ...
        self.assertEqual("<FSTMatch <arguments ROOT 0,0..0,10> {'t': <<arguments ROOT 0,0..0,10>._all[:1]>}>", str(Marguments(_all=[MMAYBE(t=...)]).match(tgt_arguments)))
